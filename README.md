# TableOrder
테이블의 QR 코드를 이용해 좌석에서 핸드폰으로 주문을 할 수 있는 시비스입니다.
...
4. 주문 내역 페이지에서 주문 상세 정보 및 주문 완료 문구가 띄워지며 주문 취소가 가능하다.
...
# 📖배운점
* retrofit2를 통해 HTTP API 통신 방법을 알았음.
* Glide 사용법을 알았음.
* 프로젝트 진행중 팀원의 갈등 중재 및 커뮤니케이션 능력을 길러볼 수 있었음.
* git의 사용법을 알 수 있었음.
...
# 📷스크린샷 & 구동영상
* 전체 구동영상 : [TableOrder](https://www.youtube.com/watch?v=JgR_xzQibn8)
